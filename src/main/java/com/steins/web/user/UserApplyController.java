...
//		logger.error("test error!");
	...
	@ResponseBody
	@RequestMapping(value = "insertApplyHead", method = RequestMethod.POST)
...
//		logger.info("==start==");
		...
		TeamMemberExecution teamFlag;
		
		try {
			GameApply gameApply= mapper.readValue(str,GameApply.class);
			List<TeamMember> list=new ArrayList<>();
			list=gameApply.getTeamMember();
			teamFlag=userApplyService.insertTeamMember(list);
			flag = userApplyService.insertApplyHead(gameApply);
			modelMap.put("teamFlag",teamFlag);
